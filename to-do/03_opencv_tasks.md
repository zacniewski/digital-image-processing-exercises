...
1. **Wczytanie i wyświetlenie obrazu**
   ...
   - Pomocne skrypty: `scripts/opencv_images1.py`

1. **Zapisywanie obrazu**

   - Zadanie: Wczytaj kolorowy obraz, przekonwentuj go na skalę szarości i zapisz jako nowy plik `.jpg`.
   - Podpowiedź: Do konwersji użyj `cv2.cvtColor(img, cv2.COLOR_BGR2GRAY)`, a do zapisu `cv2.imwrite()`.
   - Pomocne skrypty: `scripts/opencv_images1.py` (zapis), `scripts/opencv_edge_detection.py` (konwersja na skalę szarości)
...
1. **Rysowanie linii**
   ...
   - Pomocne skrypty: `scripts/opencv_rysowanie.py`
...
1. **Rysowanie okręgów i prostokątów**
   ...
   - Pomocne skrypty: `scripts/opencv_rysowanie.py`, `scripts/opencv_image_drawing.py`
...
1. **Zmiana rozmiaru (Resizing)**
   ...
   - Pomocne skrypty: `scripts/opencv_images2.py`, `scripts/opencv_mouse_and_trackbar_gui.py`
...
1. **Tworzenie prostego GUI z suwakiem**
   ...
   - Pomocne skrypty: `scripts/opencv_mouse_and_trackbar_gui.py`, `scripts/opencv_canny_tracker.py`
...
1. **Rozmycie obrazu (Blur)**
   ...
   - Pomocne skrypty: `scripts/opencv_edge_detection.py`, `scripts/opencv_color_tracking.py`
...
1. **Wykrywanie krawędzi (Canny)**
   ...
   - Pomocne skrypty: `scripts/opencv_canny_tracker.py`, `scripts/opencv_edge_detection.py`
...
1. **Rysowanie wielokąta**
   ...
   - Pomocne skrypty: `scripts/opencv_color_tracking.py` (wykorzystuje `cv2.drawContours`)
...
1. **Interaktywne zamykanie okna**
   ...
   - Pomocne skrypty: `scripts/opencv_color_tracking.py`, `scripts/opencv_canny_tracker.py`
